// VENDORED from ml-explore/mlx-swift-lm Libraries/MLXLLM/Models/Qwen35.swift (MIT License).
//
...
public struct E0Qwen35TextConfiguration: Codable, Sendable {
...
final class E0Qwen35GatedDeltaNet: Module {
    let hiddenSize: Int
    let numVHeads: Int
    let numKHeads: Int
    let headKDim: Int
    ...
    @ModuleInfo(key: "norm") var norm: E0Qwen3NextRMSNormGated
    ...
    init(_ args: E0Qwen35TextConfiguration) {
        ...
        _norm.wrappedValue = E0Qwen3NextRMSNormGated(dimensions: headVDim, eps: args.rmsNormEps)
...
final class E0Qwen35Attention: Module {
...
final class E0Qwen35SparseMoeBlock: Module, UnaryLayer {
    let normTopkProb: Bool
    let numExperts: Int
    let topK: Int

    @ModuleInfo(key: "gate") var gate: Linear
    @ModuleInfo(key: "switch_mlp") var switchMLP: E0SwitchGLU
    ...
    init(_ args: E0Qwen35TextConfiguration) {
        ...
        _switchMLP.wrappedValue = E0SwitchGLU(
            inputDims: args.hiddenSize,
            hiddenDims: args.moeIntermediateSize,
            numExperts: args.numExperts
        )

        _sharedExpert.wrappedValue = E0Qwen3NextMLP(
...
final class E0Qwen35DecoderLayer: Module {
    let isLinear: Bool

    @ModuleInfo(key: "self_attn") var selfAttn: E0Qwen35Attention?
    @ModuleInfo(key: "linear_attn") var linearAttn: E0Qwen35GatedDeltaNet?
    ...
    init(_ args: E0Qwen35TextConfiguration, layerIdx: Int) {
        self.isLinear = (layerIdx + 1) % args.fullAttentionInterval != 0

        if isLinear {
            _linearAttn.wrappedValue = E0Qwen35GatedDeltaNet(args)
        } else {
            _selfAttn.wrappedValue = E0Qwen35Attention(args)
        }

        if args.numExperts > 0 {
            _mlp.wrappedValue = E0Qwen35SparseMoeBlock(args)
        } else {
            _mlp.wrappedValue = E0Qwen3NextMLP(
                dimensions: args.hiddenSize,
...
public class E0Qwen35TextModelInner: Module {
    @ModuleInfo(key: "embed_tokens") var embedTokens: Embedding

    fileprivate let layers: [E0Qwen35DecoderLayer]
    let norm: RMSNorm
    ...
    init(_ args: E0Qwen35TextConfiguration) {
        ...
        self.layers = (0 ..< args.hiddenLayers).map { layerIdx in
            E0Qwen35DecoderLayer(args, layerIdx: layerIdx)
        }
...
public class E0Qwen35TextModel: Module, LLMModel, KVCacheDimensionProvider {
    public let vocabularySize: Int
    public let kvHeads: [Int]

    public let model: E0Qwen35TextModelInner
    let configuration: E0Qwen35TextConfiguration
    ...
    public init(_ args: E0Qwen35TextConfiguration) {
        ...
        self.model = E0Qwen35TextModelInner(args)
...
extension E0Qwen35TextModel: LoRAModel {
...
public class E0Qwen35Model: Module, LLMModel, KVCacheDimensionProvider {
    public let vocabularySize: Int
    public let kvHeads: [Int]

    @ModuleInfo(key: "language_model") var languageModel: E0Qwen35TextModel

    public init(_ args: E0Qwen35Configuration) {
        let textModel = E0Qwen35TextModel(args.textConfig)
...
extension E0Qwen35Model: LoRAModel {
    public var loraLayers: [Module] {
