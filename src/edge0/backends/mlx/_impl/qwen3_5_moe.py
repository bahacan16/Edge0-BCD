...
#
# edge0 vendored copy of mlx-lm 0.31.0 ``mlx_lm/models/qwen3_5_moe.py``,
# byte-identical EXCEPT the import block (absolute paths; the qwen3_5
# sibling resolves to this vendored package).

from dataclasses import dataclass

from mlx_lm.models.base import BaseModelArgs
from edge0.backends.mlx._impl.qwen3_5 import Model as Qwen3_5Model
